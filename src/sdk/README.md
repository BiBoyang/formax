...
- Query debug-option alignment (`debug` supported via hook-debug env wiring; `debugFile` accepted as contract input and currently fails explicitly as unsupported)
