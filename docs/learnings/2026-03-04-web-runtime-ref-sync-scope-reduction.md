...
- Updated `apps/web-reference-react/src/app/useAppRuntime.ts` callsite to match narrowed hook contract.

- Added `apps/web-reference-react/src/app/runtime/useRuntimeRefSync.test.tsx`:
...
- `npm --prefix apps/web-reference-react run test -- src/app/runtime/useRuntimeRefSync.test.tsx src/App.test.tsx`
