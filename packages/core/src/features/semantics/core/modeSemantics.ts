import type { PromptBlock } from '@formax/shared/prompts'
import { buildExitedPlanModeSystemReminder, buildPlanModeSystemReminder } from '@formax/shared/utils/planModeReminders'
