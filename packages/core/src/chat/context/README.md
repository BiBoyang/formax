...
- `packages/core/src/features/repl/sessionRestore/sessionMemory.ts`：从 active history 重建并刷新 session memory sidecar 的共享 helper（turn completion 与 restore 路径共用）
