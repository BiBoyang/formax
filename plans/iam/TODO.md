...
- [ ] B4 Delete rule / Add directory / Delete directory / dismissed 行：`src/entrypoints/permissions.tsx` + store（已接 Delete rule + Add directory + Delete directory；dismissed 行待补）
