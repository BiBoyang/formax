...
2. `docs/contracts/app-server-interaction-contract.md`（协议与状态机合同）
3. `docs/frontend/app-server-ui-spec.md`（UI 功能行为规范）
4. `docs/references/app-server-api-reference.md`（实现参考与示例）
